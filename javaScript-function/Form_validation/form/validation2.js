...
function validate() {
   if(document.myForm.Name.value == "" ) {
            ...
            return false;
         }else{  let NAME = document.getElementById("NAME").value;}
 ...
 if( document.myForm.Zip.value == "" || isNaN( document.myForm.Zip.value ) ||
         ...
         else{ let zipid = document.getElementById("ZipID").value;}
  if(document.myForm.Country.value == "-1" ) {
            alert( "Please provide your country!" );
            return false;         }
          else {let CountryId = document.getElementById("CountryId").value;}
