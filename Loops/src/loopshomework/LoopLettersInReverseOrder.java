...
public class LoopLettersInReverseOrder {
	...
	public static void main(String[] args) {
		// Write a for loop that starts at the final position in the array and count down
		
		//create primitive string data type letters and assign a to z String value of letters 
